...
class _MyCartViewState extends State<MyCartView> with TickerProviderStateMixin {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: Form(
        key: formGlobalKey,
        child: Obx(
          () => Get.find<MyCartController>().isShowCartIcon.value &&
                  Get.find<MyCartController>().cartItemCount.value == 0
              ? Center(
              ...
              : Column(
                  ...
                  children: [
                    ...
                    Expanded(
                      flex: 1,
                      child: myCartController.cartItemCount.value == 0
                          ? Container(
                              child: Column(
                                crossAxisAlignment: CrossAxisAlignment.start,
                                children: [
                                                        ...
                                                        child: Container(
                                                            ...
                                                            decoration:
                                                              ...
                                                              image:
                                                                ...
                                                                image:
                                                                    NetworkImage(
                                                                  '${myCartController.addToCartList.cartItems?[index]?.product_image == '' ? AppService.noImageUrl : myCartController.addToCartList.cartItems?[index]?.product_image}',
                                                                ),
                                                                fit: BoxFit
                                                                    .cover,
                                                              ),
                                                          ...
                                                          children: [
                                                            Padding(
                                                              ...
                                                              child:
                                                                  CustomeTextStyle(
                                                                text:
                                                                    '${myCartController.addToCartList.cartItems?[index]?.product_name}',
                                                                size: 14,
                                                                fontWeight:
                                                                    FontWeight
                                                                        .w600,
                                                            ...
                                                            CustomeTextStyle(
                                                              text: 'Rs ' +
                                                                  '${myCartController.addToCartList.cartItems?[index]?.product_price}',
                                                              size: 16,
                                                              fontWeight:
                                                                  FontWeight
                                                                      .w700,
                                                                ...
                                                                Container(
                                                                  ...
                                                                  child: Center(
                                                                    child:
                                                                        CustomeTextStyle(
                                                                      text:
                                                                          '${myCartController.addToCartList.cartItems?[index]?.quantity}',
                                                                      size: 14,
                                                                      fontWeight:
                                                                          FontWeight
                                                                              .w600,
                                                ...
                                                child: Padding(
                                                  ...
                                                  child: Container(
                                                    ...
                                                    child: Center(
                                                      child: CustomeTextStyle(
                                                        text: 'Rs ' +
                                                            '${myCartController.addToCartList.cartTotals?.total}',
                                                        size: 16,
                                                        fontWeight:
                                                            FontWeight.w700,
                                                        color: CustomAppColors
...
class MyCartView extends GetView<MyCartController> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: Obx(
        () => Get.find<MyCartController>().isShowCartIcon.value &&
                Get.find<MyCartController>().cartItemCount == 0
            ? Center(
                child: Padding(
                  padding: EdgeInsets.only(
                    top: deviceHeight(context),
                  ),
                  child: CircularProgressIndicator(
                    color: CustomAppColors.lblOrgColor,
                    backgroundColor: CustomAppColors.switchOrgColor,
            ...
            : Column(
                ...
                children: [
                  ...
                  Expanded(
                    flex: 1,
                    child: myCartController.cartItemCount == 0
                        ? Container(
                            child: Column(
                              crossAxisAlignment: CrossAxisAlignment.start,
                              children: [
                              ...
                              children: [
                                Expanded(
                                  ...
                                  child: ListView.separated(
                                      ...
                                      shrinkWrap: true,
                                      scrollDirection: Axis.vertical,
                                      itemCount: myCartController.cartItemCount,
                                      itemBuilder:
                                          (BuildContext context, int index) {
                                        return Padding(
                                          padding:
