                ...
                RichText(
                  text: TextSpan(
                    children: [
                      TextSpan(
                        text:
                            'Enter the verification code that we sent you to ',
                        style: TextStyle(
                          fontFamily: 'Inter',
                      ...
                      if (formGlobalKey.currentState!.validate()) {
                        ...
                        if (isOTPNull == false) {
                          ...
                          if (strOTP.trim() != '') {
                            ...
                            print('strStoreOTP: $strStoreOTP');
                            if (strOTP == strStoreOTP) {
                              print('OTP: $strOTP');
                              controller.getOTPVerificationAPICall(
                                  strMobileNumber, strOTP);
                            } else {
                              Get.defaultDialog(
                                title: 'Validation',
                                backgroundColor: CustomAppColors.appWhiteColor,
