...
class RandomProduct {
  ...
  factory RandomProduct.fromJson(Map<String, dynamic> json) => _$RandomProductFromJson({
        ...json,
        "rawData": json,
      });

  factory RandomProduct.fromVariation(Map<String, dynamic> json) =>
