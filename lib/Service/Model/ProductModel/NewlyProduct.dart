...
class NewlyProduct {
  ...
  factory NewlyProduct.fromJson(Map<String, dynamic> json) =>
      _$NewlyProductFromJson({
        ...json,
        "rawData": json,
      });

  factory NewlyProduct.fromVariation(Map<String, dynamic> json) =>
  ...
  static List<String> variableKeys = [
    'id',
    'name',
    'slug',
    'type',
