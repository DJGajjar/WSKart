...
part of 'NewlyProduct.dart';

// **************************************************************************
// JsonSerializableGenerator
// **************************************************************************

NewlyProduct _$NewlyProductFromJson(Map<String, dynamic> json) => NewlyProduct(
      id: json['id'] as int?,
      ...
      images: NewlyProduct._fromJsonImage(json['images']),
      price: NewlyProduct._fromJson(json['price']),
      regularPrice: NewlyProduct._fromJson(json['regular_price']),
      salePrice: NewlyProduct._fromJson(json['sale_price']),
      ...
      totalSales: json['total_sales'] == null
          ? 0
          : NewlyProduct._toInt(json['total_sales']),
      relatedIds: NewlyProduct._toListInt(json['related_ids']),
      upsellIds: NewlyProduct._toListInt(json['upsell_ids']),
      ...
      afcFields: NewlyProduct._fromAcfFields(json['afc_fields']),
