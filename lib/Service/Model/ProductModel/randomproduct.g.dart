...
RandomProduct _$RandomProductFromJson(Map<String, dynamic> json) =>
    RandomProduct(
      ...
      images: RandomProduct._fromJsonImage(json['images']),
      price: RandomProduct._fromJson(json['price']),
      regularPrice: RandomProduct._fromJson(json['regular_price']),
      salePrice: RandomProduct._fromJson(json['sale_price']),
      ...
      totalSales: json['total_sales'] == null
          ? 0
          : RandomProduct._toInt(json['total_sales']),
      relatedIds: RandomProduct._toListInt(json['related_ids']),
      upsellIds: RandomProduct._toListInt(json['upsell_ids']),
      ...
      afcFields: RandomProduct._fromAcfFields(json['afc_fields']),
