...
class BestProduct {
  ...
  factory BestProduct.fromJson(Map<String, dynamic> json) =>
      _$BestProductFromJson({
        ...json,
        "rawData": json,
      });

  factory BestProduct.fromVariation(Map<String, dynamic> json) =>
