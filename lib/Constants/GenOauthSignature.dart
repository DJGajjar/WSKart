...
/// Check Path URLs allow pass consumer key & secret
bool isAllowPassRestApiKeys(String apiPath) {
  bool allow = false;

  for (String path in AppService.allowPathAuthenticationRestApiKeys) {
