...
import 'package:wskart/Constants/constants.dart';
...
class ConvertData {
  ...
  static String? stringFromConfigs(
      [dynamic value, String? language = defaultLanguage]) {
    if (value is String) {
      return value;
    }
  ...
  static String? textFromConfigs(
      [dynamic value, String? languageKey = 'text']) {
    if (value is String) {
      return value;
    }
  ...
  static String? imageFromConfigs(
      [dynamic value, String? language = defaultLanguage]) {
    if (value is String) {
      return value;
    }
